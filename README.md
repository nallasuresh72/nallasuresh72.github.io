...
The original resume contains a phone number. This website intentionally does **not** publish the phone number. The generated resume also displays a note instead of the phone number. You can add it later to `data/site-data.js` if you decide you want it public.
...
The phone number exists in the data file only as a private source value for future flexibility; it is intentionally **not rendered anywhere on the public website or generated resume**. The public resume contains no phone number.
